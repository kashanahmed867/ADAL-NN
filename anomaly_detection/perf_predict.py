...
if __name__ == '__main__':
    ...
    parser.add_argument('-type', default=torch.double, type=str)
    ...
    parser.add_argument('-model', default='model/default.pt', type=str)
    ...
    dataloader = DataLoader(SeqDataset(indir + '/my_'+ datasetName + '_test_normal', indir + '/my_'+ datasetName + '_test_abnormal', indir + '/my_' + datasetName + '_test_perf', encodingFN), batch_size=batch_size, shuffle=False, pin_memory=False, collate_fn=PadCollate(dim=0, typ=tensortype))
